      ...
      tabPanel(
        "Synthea Patients (Breast Cancer)",
          mainPanel(fluidRow(column(12,
              ...
              p('Catharine355 Kutch271 (on page 3) is a good example of a patient with robust info.')
#              span(tags$a('Catharine355 Kutch271', href='#', id='syntheaRobustPatient'),
#                  span('is a good example of a patient with robust info.'))
          ))),
          mainPanel(fluidRow(column(12,
              h4("Synthea Patients"),
              hr(),
